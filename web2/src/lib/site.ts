export const site = {
  ...
  // Monthly commit diffs are generated by a scheduled workflow in this fork
  // and committed to monthly-diffs/ on its default branch - see
  // https://github.com/Alex-Zughaid/physlib/blob/master/scripts/generate-monthly-diff.js
  monthlyDiffsRepo:
    "https://raw.githubusercontent.com/Alex-Zughaid/physlib/master/monthly-diffs",
};
